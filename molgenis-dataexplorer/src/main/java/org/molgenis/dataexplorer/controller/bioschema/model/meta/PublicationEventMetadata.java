...
@Component
public class PublicationEventMetadata extends SystemEntityType {
  private static final String SIMPLE_NAME = "publicationEvent";
  ...
  public PublicationEventMetadata(BioschemaPackage bioschemaPackage) {
  ...
  @Override
  public void init() {
    setLabel("Bioschema Publication Event");
    setPackage(bioschemaPackage);

    setDescription("Publication Event");
