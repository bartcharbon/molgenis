...
public class OneToManyCategoryAlgorithmGeneratorTest extends AbstractMolgenisSpringTest
{
	...
	public void init()
	{
		...
		Mockito.when(dataService.findAll(sourceRefEntityType.getId())).thenAnswer(invocation -> Stream
		...
		Mockito.when(dataService.findAll(sourceRefEntityType1.getId())).thenAnswer(invocation -> Stream
				.of(sourceEntity8, sourceEntity9, sourceEntity10, sourceEntity11, sourceEntity12, sourceEntity13,
						sourceEntity14, sourceEntity15, sourceEntity16));
