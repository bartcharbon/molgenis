...
{
	private CategoryMapping<String, String> mapping = CategoryMapping
			.create("blah", ImmutableMap.of("Human", "1", "Orc", "2"));
	...
	private CategoryMapping<String, String> mappingWithDefault = CategoryMapping
			.create("blah", ImmutableMap.of("Human", "1", "Orc", "2"), "3");

	private CategoryMapping<String, String> mappingWithDefaultNull = CategoryMapping
			.create("blah", ImmutableMap.of("Human", "1", "Orc", "2"), null);

	private CategoryMapping<String, String> mappingWithNullValue = CategoryMapping
			.create("blah", ImmutableMap.of("Human", "1", "Orc", "2"), "3", "5");

	private CategoryMapping<String, String> mappingWithNullValueEqualsNull = CategoryMapping
			.create("blah", ImmutableMap.of("Human", "1", "Orc", "2"), "3", null);
