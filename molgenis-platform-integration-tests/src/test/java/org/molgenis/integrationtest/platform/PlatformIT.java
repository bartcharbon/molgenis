...
public class PlatformIT extends AbstractTestNGSpringContextTests
{
	...
	public void testDeletePackageWithOneToMany()
	{
		runAsSystem(() ->
		{
			...
			EntityType entityType = testHarness
					.createDynamicTestEntityType("refEntityType_onetomany", package_, refEntityType);

			Attribute oneToManyAttribute = attributeFactory.create("onetomany").setName("onetomany")
					.setDataType(AttributeType.ONE_TO_MANY).setRefEntity(entityType)
